...
export default function Slider({ 
  ...
  const colorThemes = {
    home: {
      active: "bg-gradient-to-r from-blue-50 to-cyan-50 border-blue-200 text-blue-800 ",
      icon: "bg-gradient-to-br from-blue-500 to-cyan-500 text-white",
      dot: "bg-blue-500"
    },
    users: {
      active: "bg-gradient-to-r from-emerald-50 to-green-50 border-emerald-200 text-emerald-800",
      icon: "bg-gradient-to-br from-emerald-500 to-green-500 text-white",
      dot: "bg-emerald-500"
    },
    referrals: {
      active: "bg-gradient-to-r from-purple-50 to-violet-50 border-purple-200 text-purple-800",
      icon: "bg-gradient-to-br from-purple-500 to-violet-500 text-white",
      dot: "bg-purple-500"
    },
    'demo-classes': {
      active: "bg-gradient-to-r from-amber-50 to-orange-50 border-amber-200 text-amber-800",
      icon: "bg-gradient-to-br from-amber-500 to-orange-500 text-white",
      dot: "bg-amber-500"
    },
    'support-manager': {
      active: "bg-gradient-to-r from-rose-50 to-pink-50 border-rose-200 text-rose-800",
      icon: "bg-gradient-to-br from-rose-500 to-pink-500 text-white",
      dot: "bg-rose-500"
    },
    'admit-card': {
      active: "bg-gradient-to-r from-indigo-50 to-blue-50 border-indigo-200 text-indigo-800",
      icon: "bg-gradient-to-br from-indigo-500 to-blue-500 text-white",
      dot: "bg-indigo-500"
    },
    'results': {
      active: "bg-gradient-to-r from-teal-50 to-cyan-50 border-teal-200 text-teal-800",
      icon: "bg-gradient-to-br from-teal-500 to-cyan-500 text-white",
      dot: "bg-teal-500"
    },
    default: {
      active: "bg-gradient-to-r from-gray-50 to-blue-50 border-gray-200 text-gray-800",
  ...
  const activeTheme = activeItem ? getTheme(activeItem.id) : colorThemes.default;
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-6 min-h-[480px] ">
        ...
        <div className="flex items-center justify-between">
          ...
          {!isMobileMenuOpen && activeItem && (
            <div className="flex items-center gap-2 ">
              <div className={`w-2 h-2 rounded-full ${activeTheme.dot} animate-pulse`}></div>
        ...
        {isMobile && (
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200/60">
            <div>
              ...
              <p className="text-sm text-gray-500 font-medium">Navigation Menu</p>
            </div>
            <button
              onClick={toggleMobileMenu}
          ...
          {items.map((it) => {
            ...
            return (
              <li key={it.id}>
                ...
                >
                  <span className={`w-10 h-10 flex items-center justify-center rounded-xl transition-all duration-300 shadow-sm ${
                    active 
                  ...
                  {active && (
                    <div className={`w-2 h-2 rounded-full ${theme.dot} ml-2 flex-shrink-0 animate-pulse`} />
                  )}
                </button>
              </li>
            );
      ...
      <section className="flex-1 min-w-0">
        <div className={`bg-gradient-to-br from-white to-gray-50/50 rounded-2xl border border-gray-200/60 p-4 md:p-6 shadow-xl min-h-full transition-all duration-300 backdrop-blur-sm ${
              ...
              <div className="mb-4 md:mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    {activeItem.badge && (
                      <span className={`px-3 py-1 text-xs font-bold ${activeTheme.icon} rounded-full text-white shadow-lg`}>
                        {activeItem.badge}
                      </span>
                    )}
                  </div>
              ...
              <div className="prose max-w-none">
                {activeItem.node ? (
                  ...
                  <div className="text-center py-8 md:py-12">
                    ...
                    <h3 className="text-base md:text-lg font-semibold text-gray-700 mb-2">No Content Available</h3>
