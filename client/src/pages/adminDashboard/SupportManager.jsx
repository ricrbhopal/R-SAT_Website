...
const SupportManager = () => {
  ...
  const handleViewQuery = (query) => {
    if (!query.studentId || !query.studentId._id) {
      console.error("Student details are missing in the query:", query);
      toast.error("Student details are unavailable for this query.");
      return;
    }

    setViewQuery({
      ...query,
      studentName: query.studentId.fullName,
      studentPhone: query.studentId.phoneNo,
      studentEmail: query.studentId.mail_ID,
    });
  };
